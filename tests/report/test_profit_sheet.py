...
def test_profit_sheet_squeeze_after_group_sheet(repo):
    execute(wire_domain.UpdateWire(uuid=wire1_id, sender=2, sub1="Expenses", amount=0))
    execute(wire_domain.UpdateWire(uuid=wire2_id, sender=2, sub1="Expenses", amount=0))
